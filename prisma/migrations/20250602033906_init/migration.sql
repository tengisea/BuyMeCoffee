...
CREATE TABLE "Donation" (
    ...
    "sspecialURLOrBuyMeACoffeeURL" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "BankCard" ADD CONSTRAINT "BankCard_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
